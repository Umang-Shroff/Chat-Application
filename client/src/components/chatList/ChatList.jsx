...
const ChatList = ({
  ...
  const [aiChatClicked, setAiChatClicked] = useState(false);
        ...
        <div className="p-4">
          <div>
            ...
            <div className="border-b-[1.5px] cursor-pointer">
              <div
                className={`mt-2 flex items-center rounded-lg p-3 mb-2 ${
                  aiChatClicked ? "bg-blue-300" : "bg-blue-200"
                } hover:bg-blue-300`}
                onClick={() => {
                  setAiChatClicked(true);
                  onSelectAi();
                }}
              >
                <div className="w-10 h-10 bg-white flex justify-center items-center rounded-full mr-3">
            ...
            {filteredData.length > 0 ? (
                    ...
                    <div key={key} className="border-b-[1.5px] cursor-pointer">
                      ...
                      >
                        <div
                          ...
                          } flex justify-center items-center rounded-full mr-3`}
                        >
                          {user?.profileImage ? (
                            <img
                        ...
                        <div className="flex-1">
                          <div className="flex justify-between items-center">
                            <div className="flex flex-col">
                              ...
                              {typingCheck?.userId &&
                              typingCheck?.userId !== userData.id &&
                              typingCheck?.conversationId === conversationId ? (
                            ...
                            <span
                              className={`text-xs ${
                                setOnline.some((x) => x.userId === user?.id)
              ...
              <div className="text-center text-lg mt-16 font-semibold">
                No Conversations
              </div>
            )}
          </div>
