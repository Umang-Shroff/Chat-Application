...
const Dashboard = () => {
 ...
 <div className="absolute bottom-10 flex flex-col justify-center items-center space-y-4 z-10">
      ...
      <div className="w-[65%] border overflow-y-hidden overflow-x-hidden h-screen">
        ...
        {/* Chat messages */}
        <div className="bg-blue-50 w-full h-screen pt-[20%] pb-20 overflow-hidden relative">
        ...
        {selectedName && (
          <div className="fixed bottom-0 w-[70%] h-[12%] bg-white border-t-[1.5px] shadow-md flex items-center px-6">
            ...
            />
            {typedText.length > 0 ? (
              <button onClick={sendMessage} type="submit" className="ml-4 w-12 h-12 flex items-center justify-center border rounded-full bg-blue-500 hover:bg-blue-400">
                <SendRoundedIcon className="text-white" />
              </button>
            ) : (
              <button disabled type="submit" className="ml-4 w-12 h-12 flex items-center justify-center border rounded-full bg-blue-500">
                <SendRoundedIcon className="text-white" />
              </button>
            )}
          </div>
